...
var require_dist = __commonJS({
  "node_modules/@sanity/vision/node_modules/json5/dist/index.js"(exports, module) {
    !function(u, D) {
      ...
      var F = e.Space_Separator, C2 = e.ID_Start, A = e.ID_Continue;
      function r(u2) {
      ...
      return { parse: function(u2, D2) {
          ...
          if (null != C3 && "object" === (void 0 === C3 ? "undefined" : i(C3)))
            if (Array.isArray(C3))
              for (var A2 = 0; A2 < C3.length; A2++) {
                var r2 = String(A2), t3 = u3(C3, r2, F2);
                void 0 === t3 ? delete C3[r2] : Object.defineProperty(C3, r2, { value: t3, writable: true, enumerable: true, configurable: true });
              }
            else
              for (var n2 in C3) {
                var E2 = u3(C3, n2, F2);
                void 0 === E2 ? delete C3[n2] : Object.defineProperty(C3, n2, { value: E2, writable: true, enumerable: true, configurable: true });
              }
          return F2.call(D3, e2, C3);
        }({ "": v }, "", D2) : v;
      }, stringify: function(u2, D2, e2) {
        var F2 = [], C3 = "", A2 = void 0, n2 = void 0, E2 = "", a2 = void 0;
        ...
        function v2(u3, D3) {
          ...
          return "string" == typeof e3 ? m2(e3) : "number" == typeof e3 ? String(e3) : "object" === (void 0 === e3 ? "undefined" : i(e3)) ? Array.isArray(e3) ? function(u4) {
            ...
            var D4 = C3;
            C3 += E2;
            var e4 = A2 || Object.keys(u4), r2 = [], t3 = true, n3 = false, i2 = void 0;
            try {
              for (var a3, o3 = e4[Symbol.iterator](); !(t3 = (a3 = o3.next()).done); t3 = true) {
            ...
            return F2.pop(), C3 = D4, f3;
          }(e3) : void 0;
        }
        function m2(u3) {
          var D3 = { "'": 0.1, '"': 0.2 }, e3 = { "'": "\\'", '"': '\\"', "\\": "\\\\", "\b": "\\b", "\f": "\\f", "\n": "\\n", "\r": "\\r", "	": "\\t", "\v": "\\v", "\0": "\\0", "\u2028": "\\u2028", "\u2029": "\\u2029" }, F3 = "", C4 = true, A3 = false, r2 = void 0;
          try {
            for (var t3, n3 = u3[Symbol.iterator](); !(C4 = (t3 = n3.next()).done); C4 = true) {
              var E3 = t3.value;
              switch (E3) {
                case "'":
                case '"':
        ...
        function p2(u3) {
          ...
          for (var e3 = D3.length; e3 < u3.length; e3++)
            if (!t2(String.fromCodePoint(u3.codePointAt(e3))))
              return m2(u3);
          return u3;
        }
      } };
...
//# sourceMappingURL=SanityVision-ce40d94b.esm-ZH3ZMX5E.js.map
